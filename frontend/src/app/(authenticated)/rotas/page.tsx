...
export default function RotasPage() {
  ...
  const [selectedRotaForPrint, setSelectedRotaForPrint] = useState<Rota | null>(
    null
  );
  ...
  const {
    ...
    title: "Excluir Rota",
    description:
      "Esta ação não pode ser desfeita. A rota e todos os atendimentos associados serão removidos permanentemente.",
  ...
  const handleEdit = (rota: Rota) => {
    ...
    setFormData({
      ...
      dataAtendimento: rota.dataAtendimento
        ? rota.dataAtendimento.split("T")[0]
        : "",
    });
    setDialogOpen(true);
  };
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("dataAtendimento", e.target.value)
                  }
                />
              </div>
              <Button
                ...
                className="w-full"
                disabled={
                  createRotaMutation.isPending || updateRotaMutation.isPending
                }
              >
                {editingRota
          ...
          <TableBody>
            {isLoading ? (
              ...
              <TableRow>
                ...
                >
                  {params.search
                    ? "Nenhuma rota encontrada para a busca."
